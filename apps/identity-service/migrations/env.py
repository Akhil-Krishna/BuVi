...
from identity_service.infrastructure.db.models import SCHEMA, Base
...
def _do_run_migrations(connection: Connection) -> None:
    # Alembic's version table lives in this service's own schema, so the schema
    # has to exist before Alembic can read it -- including on a fresh database
    # where the first migration is what would otherwise create it.
