"""Alembic environment for semantic-service.
...
from semantic_service.core.config import get_settings
from semantic_service.infrastructure.db.models import SCHEMA, Base
