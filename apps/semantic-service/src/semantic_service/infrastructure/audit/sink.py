...
Metric definitions are governance records: creation, approval and deprecation are audited.
...
(without its state) for replay and the operation stands -- a metric approval is not
rolled back because the audit hop was briefly down (the same trade-off as ADR 0004).
"""
...
from semantic_service.core.config import SCOPE_AUDIT_WRITE
