"""Alembic environment for metadata-service.
...
from metadata_service.core.config import get_settings
from metadata_service.infrastructure.db.models import SCHEMA, Base
