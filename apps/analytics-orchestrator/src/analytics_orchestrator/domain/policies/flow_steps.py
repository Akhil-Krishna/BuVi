...
STEP_EVENTS: Final[dict[str, StepEvents]] = {
    ...
    "resolve_semantics": StepEvents(
        "semantic", "Matching business definitions", "Business definitions matched"
    ),
    ...
    "analyze_result": StepEvents("visualization", started="Summarizing and visualizing results"),
    "build_chart_spec": StepEvents(None),
