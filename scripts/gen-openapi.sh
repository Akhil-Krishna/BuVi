...
mkdir -p "$OUT"
export IDENTITY_LOG_LEVEL=WARNING GATEWAY_LOG_LEVEL=WARNING METADATA_LOG_LEVEL=WARNING QUERY_GATEWAY_LOG_LEVEL=WARNING ANALYTICS_LOG_LEVEL=WARNING WORKER_LOG_LEVEL=WARNING VISUALIZATION_LOG_LEVEL=WARNING DASHBOARD_LOG_LEVEL=WARNING SEMANTIC_LOG_LEVEL=WARNING
